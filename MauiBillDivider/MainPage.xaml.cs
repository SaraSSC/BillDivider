namespace MauiBillDivider
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            //Total gorjetas
            var totalGorjetas = (conta * gorjeta) / 100;

            var gorjetaPorPessoa = (totalGorjetas / numeroPessoas);
            ...
            //Total
            var totalPorPessoa = (conta + totalGorjetas / numeroPessoas);
